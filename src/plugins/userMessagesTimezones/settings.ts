...
export const settings = definePluginSettings({
    timeFormat: {
        ...
        options: [
            {
                /**
                 * This option should be responsible for automatically detecting the user's preferred time format based on their discord time preferences.
                 * It's currently based on the i18n locale and isn't exactly aligned with the discord settings.
                 */
                label: "Auto",
                value: TimeFormat.Auto,
                default: true
            }, // Other custom overwrites
            {
                label: "24-hour (HH:MM)",
